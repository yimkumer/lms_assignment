...
import 'package:lms/drawer_layouts/accounts.dart';
import 'package:lms/drawer_layouts/admission.dart';
import 'package:lms/drawer_layouts/examinations.dart';
...
class _communicationState extends State<communication> {
  var currentPage = DrawerSections.communication;
          ...
          child: Column(children: [
            ...
            Row(
              children: [
                ...
                Padding(
                  padding: const EdgeInsets.fromLTRB(45, 10, 60, 0),
            ...
            Row(
              children: [
                ...
                Padding(
                  padding: const EdgeInsets.fromLTRB(45, 21, 40, 0),
                  child: Column(children: const [
                    IconButton(
                        onPressed: null,
                        icon: Icon(
